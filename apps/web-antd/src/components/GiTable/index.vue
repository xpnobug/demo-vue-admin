...
.gi-table {
  ...
  &__container {
    ...
    // 控制table高度占满
    :deep(.antd-table-border:not(.antd-table-border-cell) .antd-table-container) {
      height: 100%;
    }

    :deep(.antd-table-body) {
      height: 100%;
    }

    // 控制表格最后一行的下边框显示
    :deep(.antd-table-border .antd-table-scroll-y .antd-table-body .antd-table-tr:last-of-type .antd-table-td,
      .antd-table-border .antd-table-scroll-y tfoot .antd-table-tr:last-of-type .antd-table-td) {
  ...
  &__body {
    ...
    //如果为空时，将表格铺满
    :deep(.antd-table-element):has(tbody .antd-table-tr-empty) {
      height: 100%;
    }

    // 分页默认位置
    :deep(.antd-pagination) {
      margin-top: 10px;
      justify-content: end;
    }
    ...
    :deep(.link-text.antd-typography) {
  ...
  &__toolbar {
    :deep(.antd-form-item-layout-inline) {
      margin-right: 8px;
    ...
    :deep(.antd-form-layout-inline .antd-form-item) {
      margin-bottom: 0;
    }
  }
